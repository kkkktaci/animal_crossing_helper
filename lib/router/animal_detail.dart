...
class AnimalDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: StoreConnector<AppState, _AnimalViewModal>(
          distinct: true,
          converter: (store) => _AnimalViewModal(animal: store.state.animal.animal.singleWhere((item) => item.name == animal.name)),
  ...
  Widget _buildInfo(BuildContext context, _AnimalViewModal vm) {
    return Container(
      width: MediaQuery.of(context).size.width,
      ...
      child: Column(
        children: <Widget>[
          ...
          _buildContainer(
            child: Center(
              child: Text('${animal.name} ${animal.sex}', style: Theme.of(context).textTheme.display1,),
            )
          ),
          Row(
  ...
  Widget _buildTitleInfo(BuildContext context, String title, String content, bool halfSize) {
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(content == null ? '正在加载' : content, style: Theme.of(context).textTheme.display1, maxLines: 1, )
            )
          ],
        )
      )
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Center(child: Text('座右铭', style: Theme.of(context).textTheme.display3,)),
          ),
          Text(motto == null ? '正在加载' : motto, style: Theme.of(context).textTheme.display1, overflow: TextOverflow.ellipsis,)
        ],
      ),
    );
  }
...
class _AnimalViewModal {
  Animal animal;

  _AnimalViewModal({this.animal});

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is _AnimalViewModal &&
